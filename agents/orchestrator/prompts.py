...
1. **MyCareer Agent** (mycareer worker agent)
...
2. **JD Generator Agent** (jd_generator worker agent)
...
- If the user's message clearly relates to their own career, profile, job search, or messaging -- route to mycareer worker agent.

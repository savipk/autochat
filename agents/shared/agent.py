"""
MyCareer agent factory — kept for reference.

The mycareer agent is no longer registered in the catalog.
Its functionality has been split into profile, job_discovery, and outreach agents.
Tools and middleware remain in agents/shared/ as a shared library.
"""
...
from agents.shared.middleware import first_touch_profile_middleware, mycareer_personalization, profile_warning_middleware
from agents.shared.prompts import MYCAREER_SYSTEM_PROMPT, MYCAREER_WELCOME_ADDENDUM
